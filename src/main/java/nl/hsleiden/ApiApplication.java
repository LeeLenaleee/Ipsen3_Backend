...
//        filter.setInitParameter("allowedOrigins", "http://localhost:4200,192.168.1.18:4200");    // hier het server ip invullen waar angular op draait, kan meerdere ips doen door comma gescheiden
